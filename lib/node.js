...
Node.prototype.handleBlock = function (e) {
  ...
  if (this.cfg.network.altChain == true) {
    blockData.coinbase = new Transaction(e.message.coinbase);
    blockData.merkle_link = e.message.merkle_link;
    blockData.aux_branches = e.message.aux_branches;
    blockData.aux_index = e.message.aux_index;
    blockData.aux_parent = e.message.aux_parent;
  }
