...
var encodeBase58 = exports.encodeBase58 = base58.encode;

var decodeBase58 = exports.decodeBase58 = base58.decode;

/**
 * Create a new Buffer object, identical to the passed one
 */
var cloneBuffer = exports.cloneBuffer = function(buff) {
  if (!Buffer.isBuffer(buff)) return false;
  var clone = new Buffer(buff.length);
  buff.copy(clone);
  return clone;
}
...
var formatHashFull = exports.formatHashFull = function (hash) {
  var copy = cloneBuffer(hash); // Make a copy, because reverse() and toHex() are destructive.
...
// Initializations
try {
  var NULL_HASH = exports.NULL_HASH = new Buffer(32);
  NULL_HASH.fill(0);
  var EMPTY_BUFFER = exports.EMPTY_BUFFER = new Buffer(0);
  var ZERO_VALUE = exports.ZERO_VALUE = new Buffer(8);
  ZERO_VALUE.fill(0);
